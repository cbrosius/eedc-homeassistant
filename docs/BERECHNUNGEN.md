...
| Aussichten/Kurzfristig | `GET /api/aussichten/kurzfristig/{id}` | 7-Tage PV-Prognose |
...
**Datenquelle:** Open-Meteo Wettervorhersage
...
| Globalstrahlung | Open-Meteo Forecast API | - |
