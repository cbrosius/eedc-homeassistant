...
|---------|-------------|---------------|
| Monatsabschluss-Wizard | Zentrale monatliche Datenerfassung mit Quellen-Status und Vorschlägen | Keine |
...
| Cloud-Import | Direktabruf aus Hersteller-Cloud-APIs | API-Zugangsdaten |
...
:::tip[Einrichtung-Hub]
Unter **Einstellungen → Daten → Einrichtung** findest du alle Datenquellen-Optionen zentral an einem Ort.
:::
